...
import br.com.greg.converter.mocks.MockPerson;
...
public class DozerConverterTest {
    ...
    public void parseEntityListToVOListTest() {
        List<PersonVO> outputList = DozerConverter.parserObject(inputObject.mockEntityList(), PersonVO.class);
	 ...
	 public void parserVOListToEntityListTest() {
        List<Person> outputList = DozerConverter.parserObject(inputObject.mockVOList(), Person.class);
